...
const brandIcons: IconProps[] = [
  { id: 1, icon: IconGoogle, className: 'top-[15%] left-[12%]' },
  { id: 2, icon: IconApple, className: 'top-[22%] right-[10%]' },
  { id: 3, icon: IconMicrosoft, className: 'top-[75%] left-[15%] hidden sm:block' },
  { id: 4, icon: IconFigma, className: 'bottom-[12%] right-[15%]' },
  { id: 5, icon: IconGitHub, className: 'top-[8%] left-[30%] hidden sm:block' },
  { id: 6, icon: IconSlack, className: 'top-[5%] right-[28%]' },
  { id: 7, icon: IconVercel, className: 'bottom-[10%] left-[30%]' },
  { id: 8, icon: IconStripe, className: 'top-[42%] left-[8%] hidden md:block' },
  { id: 9, icon: IconDiscord, className: 'top-[65%] right-[20%]' },
  { id: 10, icon: IconX, className: 'top-[85%] left-[65%] hidden sm:block' },
  { id: 11, icon: IconNotion, className: 'top-[48%] right-[6%] hidden md:block' },
  { id: 12, icon: IconSpotify, className: 'top-[58%] left-[6%] hidden sm:block' },
  { id: 13, icon: IconDropbox, className: 'top-[8%] left-[55%] hidden md:block' },
  { id: 14, icon: IconTwitch, className: 'bottom-[8%] right-[40%] hidden lg:block' },
  { id: 15, icon: IconLinear, className: 'top-[28%] right-[18%] hidden sm:block' },
  { id: 16, icon: IconYouTube, className: 'top-[62%] left-[35%] hidden sm:block' },
];
...
export function BrandTrustStrip() {
  return (
    <div id="brands">
      <FloatingIconsHero
        title="Trusted by Pakistan's top consumer brands"
        subtitle="Over 120+ custom-scripted, native brand integrations delivered with trackable ROI."
